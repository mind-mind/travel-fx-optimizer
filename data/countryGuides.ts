...
export const COUNTRY_GUIDES: CountryGuide[] = [
  {
    ...
    heroTipEn: "In China, Alipay and WeChat Pay are the dominant payment methods — link your Thai card before you go.",
    bestPaymentMethodEn: "Alipay / WeChat Pay (linked to a Thai credit card)",
    topTipsEn: [
      "Register Alipay or WeChat Pay before departure and link your Thai credit card.",
      ...
      "Choose a bank with a low FX fee such as KBank or SCB.",
      "Always check the rate before swiping — never accept THB billing (DCC).",
    ],
    avoidTipEn: "Never accept DCC when paying by card at merchants or hotels in China.",
    dccNoteEn: "Many merchants in China offer to charge in Thai Baht — always decline and choose to pay in CNY.",
    bestCardEn: "KBank Mastercard or SCB Visa — among the lowest FX fees available.",
  },
  {
    countryCode: "JP",
    countryName: "ญี่ปุ่น",
    ...
    bestPaymentMethodEn: "Cash JPY + low-fee credit card",
    topTipsEn: [
    ...
    avoidTipEn: "Avoid exchanging money at Thai airports — rates are significantly worse than in Japan.",
    dccNoteEn: "When swiping your card in Japan, always choose JPY. Never select THB even if offered.",
    bestCardEn: "KBank or TTB Flash Card — some variants have zero foreign transaction fees.",
  },
  {
    countryCode: "KR",
    ...
    bestPaymentMethodEn: "Thai credit card + T-Money Card",
    topTipsEn: [
    ...
    avoidTipEn: "Never exchange KRW in Thailand — rates are very poor. Withdraw or exchange in Korea directly.",
    dccNoteEn: "When paying by card in Korea, always select KRW. Avoid the THB option if offered (DCC).",
    bestCardEn: "KTC or KBank Mastercard — competitive FX fees for KRW transactions.",
  },
  {
    countryCode: "SG",
    ...
    bestPaymentMethodEn: "Thai credit card with low FX fee",
    topTipsEn: [
      "Credit cards are the best option in Singapore — accepted at almost all hawker centres and shops.",
      "PayNow / PayLah! require a Singapore bank account and aren't suitable for Thai tourists.",
    ...
    bestCardEn: "KBank Visa or Bangkok Bank — broad Visa acceptance across Singapore.",
  },
  {
    countryCode: "HK",
    countryName: "ฮ่องกง",
    ...
    dccNoteEn: "In Hong Kong, always choose HKD when paying by card. Decline if THB is offered.",
    bestCardEn: "SCB JCB or Krungsri — both offer benefits on Hong Kong spending.",
  },
  {
    countryCode: "TW",
    countryName: "ไต้หวัน",
    ...
    dccNoteEn: "In Taiwan, always choose TWD when swiping your card — not THB.",
    bestCardEn: "KBank or SCB Mastercard — widely accepted across Taiwan.",
  },
];
